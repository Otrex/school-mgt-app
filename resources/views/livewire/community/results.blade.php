                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card revenue-card">
                            <div class="card-body">
                                <h5 class="card-title">Total Program <span></span></h5>
                                ...
                                <table class="table table-stripped">
                                    ...
                                    @forelse ($results as $exam_result)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('community.member.result.view', $exam_result) }}" title="View Result Details" class="text-center">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4"><div class="text-center"><em>Result(s) not available</em></div></td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
