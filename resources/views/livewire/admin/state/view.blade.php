    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.states') }}">All State</a></li>
                ...
                <div class="card">
                    <div class="card-body pt-3" x-data="{ activeTab:  0 }">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" @click="activeTab = 1" class="tab-control" :class="{ 'active': activeTab === 1 }">Edit State</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show profile-overview" :class="{ 'active': activeTab === 0 }" x-show.transition.in.opacity.duration.600="activeTab === 0" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $state->name }}</div>
                                </div>
                            </div>
                                ...
                                <form wire:submit.prevent="save">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input wire:model.defer="state.name" type="text" class="form-control" id="state">
                                            <x-inline-error name="state.name" />
                                        </div>
                                    </div>
