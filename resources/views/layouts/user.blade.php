    ...
    <body>
                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown pe-3">
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                            @livewire('components.student-avatar', ['type' => '-nav'])
                            <span class="d-none d-md-block dropdown-toggle ps-2">
                                {{ strtoupper(auth()->user()->first_name[0]) }}. {{ ucwords(auth()->user()->last_name) }}
                            </span>
                        </a><!-- End Profile Iamge Icon -->
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            <li class="dropdown-header">
                                <h6>{{ ucwords(auth()->user()->fullname) }}</h6>
                                <span>Reg No. {{ auth()->user()->reg_no }}</span>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('student.results') ? '' : 'collapsed' }}" href="{{ route('student.results') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('student.certificate') ? '' : 'collapsed' }}" href="{{ route('student.certificate') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('student.profile') ? '' : 'collapsed' }}" href="{{ route('student.profile') }}">
                    <i class="bi bi-person"></i>
                    <span>Profile</span>
                    </a>
                </li>
