...
The resource **{{ $resource->type->name }}** with the serial number **{{ $resource->serial_number }}** you requested for is now **available**. Please navigate to your dashboard to check-in.
